...
\begin{picture}(4,.9)
% \put(0.8,0.1){\includegraphics[scale=.8]{figures/vectors-14_copy.pdf}}
% \put(0.8,0.2){\includegraphics[scale=.8]{figures/vectors-14.pdf}}
\put(0.8,0.0){\includegraphics[scale=.13]{figures/vectors-14.png}}
...
\begin{solution}
    \begin{picture}(4,.9)
	\put(0.4,0.1){\includegraphics[scale=.8]{figures/vectors-15_copy.pdf}}
...
\pause
\begin{picture}(3,.9)
    \put(0.3,0.1){\includegraphics[scale=.8]{figures/vectors-16_copy.pdf}}
    % \put(0.3,0.2){\includegraphics[scale=.8]{figures/vectors-16.pdf}}
...
\begin{solution}
    \begin{picture}(2,1.4)
	% \put(0.2,0.2){\includegraphics[scale=.7]{figures/vectors-18_copy.pdf}}
...
\begin{solution}[continued]
\begin{picture}(2,1.3)
    \put(0.2,0.15){\includegraphics[scale=.065]{figures/vectors-18.png}}
    \put(0.6,0.4){\small $P_0$}
...
\begin{solution}
    \begin{picture}(2,1.3)
	\put(0.18,0.18){\includegraphics[scale=.6]{figures/vectors-19_copy.pdf}}
...
\frame{
\begin{picture}(2,1.3)
    \put(0.14,0.16){\includegraphics[scale=.65]{figures/vectors-20_copy.pdf}}
