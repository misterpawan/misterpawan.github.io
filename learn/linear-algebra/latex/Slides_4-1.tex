...
\begin{picture}(3,2.2)
    \put(0.1,0){\includegraphics[scale=.75]{figures/vectors-1_copy.pdf}}
...
\frame{
	...
	\uncover<4->{
		...
		% \put(0.25,0.1){\includegraphics[scale=1]{figures/vectors-8.pdf}}
		% \put(0.15,0){\small $0$}
...
\frame{
	...
	\begin{picture}(3.5,1.0)
	    \put(1.4,0.1){\includegraphics[scale=.7]{figures/vectors-13_copy.pdf}}
...
\frame{
	...
	% \textcolor{titletextcolour}{Example (continued)}\\[0.5em]
	\begin{picture}(3.5,1.0)
	    \put(0.4,0.1){\includegraphics[scale=.7]{figures/vectors-13_copy.pdf}}
